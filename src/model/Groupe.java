...
public class Groupe {
    ...
    private static int idgrpconnected;

      public Groupe() {
        }

    public static int getIdgrpconnected() {
        return idgrpconnected;
    }

    public static void setIdgrpconnected(int idgrpconnected) {
        Groupe.idgrpconnected = idgrpconnected;
    }
    ...
    public Groupe(int id, String nom, String description, String photo_couverture, String date_creation, User createur, String membres) {
        this.id = id;
        this.nom = nom;
    ...
    public Groupe(String nom, String description, User createur) {
        this.nom = nom;
        this.description = description;
        this.createur = createur;
    }
