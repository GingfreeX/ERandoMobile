...
public class PublicationService {
    ...
    public ArrayList<Publication> getListPub() {
        ...
        ArrayList<Publication> lspub = new ArrayList<>();
            ...
            protected void readResponse(InputStream in) throws IOException {
                ...
                try {
                    ...
                    if (nbpub == 1) {
                        ...
                        p.setCreateur(new Membre(Integer.parseInt(obj.get("user_id").toString())));
        ...
        if (lspub == null) {
            ...
            for (Publication i : lspub) {
                Membre m = new MembreService().getPubMember(i.getCreateur().getId());
