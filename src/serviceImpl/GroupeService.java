...
public class GroupeService {
    ...
    public void add(Groupe groupe) {
        con.setUrl("http://localhost/codenametest/insert.php?nom=" + groupe.getNom() + "&description=" + groupe.getDescription());
    ...
    public Groupe getGroupebyId(int id) {
        ...
        con = new ConnectionRequest() {
            ...
            protected void readResponse(InputStream in) throws IOException {
                ...
                g1.setCreateur(new Membre(Integer.parseInt(obj.get("id_createur").toString())));
    ...
    public ArrayList<Membre> getAllm() {
        ArrayList<Membre> am = new ArrayList<>();
            ...
            protected void readResponse(InputStream in) throws IOException {
                ...
                try {
                    ...
                    if (nbimg == 1) {
                        ...
                        img.setMembre(new Membre(Integer.parseInt(obj.get("id_user").toString())));
