...
public class showProduct {
    ...
    Random r = new Random();
    Random y = new Random();
    public showProduct(int id,String type) {
        this.productId = id ;
        this.type = type;
    ...
    public void start() throws IOException {
        ...
        f.addCommandListener(e->{
            ...
            Image im = URLImage.createToStorage(placeholder,keysToImages[r.nextInt(keysToImages.length)],"http://localhost/piService/produit/"+p.getImage());
            ...
            Image likeimg = URLImage.createToStorage(icon,keysToIcons[r.nextInt(keysToIcons.length)],"http://localhost/piService/produit/icons/icon.png");
            Button likebtn = new Button(likeimg);
            
            likebtn.setUIID("likeB");
            likebtn.getAllStyles().setMarginLeft(260);
            //dislike
            Image dislikeimg = URLImage.createToStorage(iconn,keysToIcons[y.nextInt(keysToIcons.length)],"http://localhost/piService/produit/icons/iconLiked.png");
            ...
            ctn2.add(new Label("Prix : "+p.getPrix()));
    ...
    public void destroy() {
     ...
     public void likeProduct(int idP,int idM){
                ...
                req.setUrl("http://localhost/piService/produit/like.php?idP="+idP+"&idM="+idM);
     ...
     public void dislikeProduct(int idP,int idM){
                ConnectionRequest req = new ConnectionRequest();
                req.setUrl("http://localhost/piService/produit/dislike.php?idP="+idP+"&idM="+idM);
     ...
     public void checkIfLiked(int idP,int idM){
                ConnectionRequest req = new ConnectionRequest();
                req.setUrl("http://localhost/piService/produit/checkIfLiked.php?idP="+idP+"&idM="+idM);
     ...
     public void checkLikes(int idP){
                ConnectionRequest req = new ConnectionRequest();
                req.setUrl("http://localhost/piService/produit/checkLikes.php?idP="+idP);
   ...
   public void subscribe(int idMembre,String Email,String type){
                ConnectionRequest req = new ConnectionRequest();
                req.setUrl("http://localhost/piService/produit/subscribe.php?idMembre="+idMembre+"&type="+type+"&email="+Email);
    ...
    public void unsubscribe(int idMembre,String type){
                ConnectionRequest req = new ConnectionRequest();
                req.setUrl("http://localhost/piService/produit/unsubscribe.php?idMembre="+idMembre+"&type="+type);
    ...
    public void checkIfSubscribed(int idMembre,String Type){
                ConnectionRequest req = new ConnectionRequest();
                req.setUrl("http://localhost/piService/produit/checkIfSubscribed.php?idMembre="+idMembre+"&type="+Type);
