    ...
    public  MesPublication(Resources theme){
        ...
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            ...
            public void actionPerformed(NetworkEvent evt) {
                ...
                List<PublicationT> listpub = (List<PublicationT>) getListPublication(new String(con.getResponseData()));
                for(PublicationT p :listpub){
...
public ArrayList<PublicationT> getListPublication(String json) {
        ArrayList<PublicationT> listPublication = new ArrayList<PublicationT>();
        try {
            ...
            for (Map<String, Object> obj : list) {
                PublicationT p = new PublicationT();
