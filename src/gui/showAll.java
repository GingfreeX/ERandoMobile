...
import com.mycompany.myapp.MyListModelProd;
...
public class showAll {
    ...
    public void start() throws IOException {
      ...
      ArrayList<Product> productsList = getAllm();
        ...
        MyListModelProd model = new MyListModelProd(listdesproduits);
        int ii=0;
    ...
    public ArrayList<Product> getAllm() {
        ...
        con.setUrl("http://localhost/piService/produit/select.php");
        con.setPost(false);
