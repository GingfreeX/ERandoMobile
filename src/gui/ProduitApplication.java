...
//class user to controle user input
        ...
        btnOk.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                req.setUrl("http://localhost/piService/produit/insert.php?titre=" + p.getTitre() + "&descritpion=" + p.getDescription() + "&prix=" + p.getPrix() + "&date="+p.getDate()+"&type="+p.getType()+"&idMembre="+User.getIdofuserAlreadyloggedin());
   ...
   hi.add(content);
    ...
    public void sendSms(String phone){
                ConnectionRequest req = new ConnectionRequest();
                req.setUrl("http://localhost/piService/produit/smsService.php?phone="+phone);
    ...
    public void sendMail(String Email){
                ConnectionRequest req = new ConnectionRequest();
                req.setUrl("http://localhost/piService/produit/mailService/sendmail.php?email="+Email);
    ...
    public ArrayList<String> getSubs(String type) {
        ...
        con.setUrl("http://localhost/piService/produit/getSubs.php?type="+type);
        con.setPost(false);
