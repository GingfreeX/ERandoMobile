...
public class listrando {
 ...
 int Usr_id=2;
  ...
  add.getF().show();
        ...
        con.setUrl("http://localhost/piService/guide/select.php");
...
con14.setUrl("http://localhost/piService/guide/ajouter_reservation.php?idrando="+ls.getId()+"&iduser="+Usr_id);
...
//                        Logger.getLogger(listrando.class.getName()).log(Level.SEVERE, null, ex);
   ...
   Image i = URLImage.createToStorage(placeholder,ls.getImage(), "http://localhost/piService/guide/images/"+ls.getImage()); 
     System.out.println("http://localhost/piService/guide/images/"+ls.getImage()); 
     Label l = new Label();
     l.setIcon(i);
   ctn1.add( l);
