...
public class MyListModel implements ListModel<Image> {
    ...
    public Image getItemAtt(final int index,String imageName) {
        ...
        Image image = URLImage.createToStorage(placeholder, "i"+index,"http://localhost/erandomobile/"+imageName);
        return image;
    }
    public Image getItemAt(final int index) {
        //disabled because it does not give us what we want , sadly...
        //do not touch @!
         Image image = URLImage.createToStorage(placeholder, "image"+index,"http://localhost/erandomobile/");
         return image;
    }
