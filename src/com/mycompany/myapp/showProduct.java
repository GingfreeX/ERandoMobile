...
public class showProduct {
    ...
    public void start() throws IOException {
        ...
        f.addCommandListener(e->{
            ...
            Image im = URLImage.createToStorage(placeholder,keysToImages[r.nextInt(keysToImages.length)],"http://localhost/erandomobile/"+p.getImage());
            ...
            Image likeimg = URLImage.createToStorage(icon,keysToIcons[r.nextInt(keysToIcons.length)],"http://localhost/erandomobile/icons/icon.png");
            Button likebtn = new Button(likeimg);
            
            likebtn.setUIID("likeB");
            likebtn.getAllStyles().setMarginLeft(260);
            //dislike
            Image dislikeimg = URLImage.createToStorage(iconn,keysToIcons[y.nextInt(keysToIcons.length)],"http://localhost/erandomobile/icons/iconLiked.png");
    ...
    public void destroy() {
     ...
     public void likeProduct(int idP,int idM){
                ...
                req.setUrl("http://localhost/erandomobile/like.php?idP="+idP+"&idM="+idM);
     ...
     public void dislikeProduct(int idP,int idM){
                ConnectionRequest req = new ConnectionRequest();
                req.setUrl("http://localhost/erandomobile/dislike.php?idP="+idP+"&idM="+idM);
     ...
     public void checkIfLiked(int idP,int idM){
                ConnectionRequest req = new ConnectionRequest();
                req.setUrl("http://localhost/erandomobile/checkIfLiked.php?idP="+idP+"&idM="+idM);
     ...
     public void checkLikes(int idP){
                ConnectionRequest req = new ConnectionRequest();
                req.setUrl("http://localhost/erandomobile/checkLikes.php?idP="+idP);
   ...
   public void subscribe(int idMembre,String Email,String type){
                ConnectionRequest req = new ConnectionRequest();
                req.setUrl("http://localhost/erandomobile/subscribe.php?idMembre="+idMembre+"&type="+type+"&email="+Email);
    ...
    public void unsubscribe(int idMembre,String type){
                ConnectionRequest req = new ConnectionRequest();
                req.setUrl("http://localhost/erandomobile/unsubscribe.php?idMembre="+idMembre+"&type="+type);
    ...
    public void checkIfSubscribed(int idMembre,String Type){
                ConnectionRequest req = new ConnectionRequest();
                req.setUrl("http://localhost/erandomobile/checkIfSubscribed.php?idMembre="+idMembre+"&type="+Type);
