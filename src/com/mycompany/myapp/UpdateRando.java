       ...
       // ac1.setText(r.getPoint_depart());
        ...
        modifier.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                req.setUrl("http://localhost/codenameone/update.php?prix=" + tfprix.getText() + "&destination=" + ac.getText() + "&nbr_places=" + tfnbplace.getText() + "&age_min=" + tfage.getText() + "&transport=" + tfmoyentran.getText() + "&type=" + cbtype.getSelectedItem().get("Line1") + "&id=" + r.getId() + "&point_depart=" + ac1.getText() + "&date=" + datePicker.getText() + "&niveau=" + cbniveau.getSelectedItem().get("Line1"));
                ...
                req.addResponseListener(new ActionListener<NetworkEvent>() {
                    ...
                    public void actionPerformed(NetworkEvent evt) {
                        ...
                        System.out.println("http://localhost/codenameone/update.php?prix=" + tfprix.getText() + "&destination=" + tfdestination.getText() + "&nbr_places=" + tfnbplace.getText() + "&age_min=" + tfage.getText() + "&transport=" + tfmoyentran.getText() + "&type=" + cbtype.getSelectedItem().get("Line1") + "&id=" + r.getId() + "&niveau=" + "&point_depart=" + r.getPoint_depart() + "&niveau=" + cbniveau.getSelectedItem().get("Line1") + "&date=" + datePicker.getText());
        ...
        supprimer.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                ConnectionRequest req = new ConnectionRequest();
                req.setUrl("http://localhost/codenameone/delete.php?id=" + r.getId() + "");
