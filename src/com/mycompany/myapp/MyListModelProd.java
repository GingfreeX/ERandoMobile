 ...
 * @author Amal
 */
public class MyListModelProd implements ListModel<Image> {

    private int selection;
    private String[] imageURLs = {
       
    };
     public MyListModelProd(String[] imageNames){
    ...
    public Image getItemAtt(final int index,String imageName) {
        ...
        Image image = URLImage.createToStorage(placeholder, "i"+index,"http://localhost/piService/produit/"+imageName);
        return image;
    }
