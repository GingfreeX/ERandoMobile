...
public class detailspublication {
    ...
    String filePath;
    String Imagecode;
    public detailspublication(Resources theme,Publication p){
        ...
        request.setUrl("http://localhost/codenameone/pi/supprimerpub.php?id="+p.getId());
...
//System.out.println("data :"+Imagecode);
            ...
            request.setUrl("http://localhost/codenameone/pi/updatepub.php");
